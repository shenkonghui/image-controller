...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ImageConfig
...
func (r *ReconcileImageConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the ImageConfig instance
	...
	// Set ImageConfig instance as the owner and controller
...
func newPodForCR(cr *githubv1.ImageConfig) *corev1.Pod {
